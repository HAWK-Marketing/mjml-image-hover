...
var MjImageHover = (_temp2 = _class = function (_BodyComponent) {
  ...
  function MjImageHover() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MjImageHover.__proto__ || Object.getPrototypeOf(MjImageHover)).call.apply(_ref, [this].concat(args))), _this), _this.componentHeadStyle = function () {
      return '\n      .' + _this.getAttribute('hover-name') + ':hover .hover {display: none !important;}\n      .' + _this.getAttribute('hover-name') + ':hover .hovered {display: block !important;}\n      * [title="' + _this.getAttribute('hover-name') + 'img"]:hover .hover {display: none !important;}\n      * [title="' + _this.getAttribute('hover-name') + 'img"]:hover .hovered {display: block !important;}\n      body[data-outlook-cycle] .' + _this.getAttribute('hover-name') + ' .hover {display: block !important;}\n      body[data-outlook-cycle] .' + _this.getAttribute('hover-name') + ' .hovered {display: none !important;}\n    </style>\n    <!--[if mso]>\n    <style type="text/css">\n    .' + _this.getAttribute('hover-name') + ' .hover{display:none !important}\n    .' + _this.getAttribute('hover-name') + ' .hovered{display:block !important}\n    </style>\n    <![endif]-->\n    <style type="text/css">\n  ';
  ...
  _createClass(MjImageHover, [{
    ...
    value: function renderImage() {
      ...
      var imgHover = '\n      ' + (0, _conditionalTag.msoConditionalTag)('<img\n        ' + this.htmlAttributes({
        alt: '',
        height: height && (height === 'auto' ? height : parseInt(height, 10)),
